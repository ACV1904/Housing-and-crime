...
The implementation was done in Jupyter notebook files, 4 of them to prepare the files and 1 to make the analysis with the pre-processed data (Analysis.ipynb). The files used and sources are explained in the file [read_ipynb_files.md]('Housing-conditions-and-crime/read_ipynb_files.md')
